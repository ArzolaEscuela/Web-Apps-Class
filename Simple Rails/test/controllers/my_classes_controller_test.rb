...
class MyClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create my_class" do
    assert_difference('MyClass.count') do
      post my_classes_url, params: { my_class: { content: @my_class.content, name: @my_class.name } }
    end
  ...
  test "should update my_class" do
    patch my_class_url(@my_class), params: { my_class: { content: @my_class.content, name: @my_class.name } }
